    ...
    return (
        <>
            <div className={lightMode ? "" : "light"}>
                ...
                <section className="Yesterday d-none d-sm-block">
                    <div className="container-fluid p-0">
                        <div className="row">
                            <div className="col-sm-11 m-auto">
                                        ...
                                        <table className="table">
                                            ...
                                            <tbody className="sndsj">
                                                <tr>
                                                    <td>
                                                        <div className="images-outer">
                                                            <img src="\coinhunt\Web - Light\image 15.png" alt="" className="img-fluid" />
                                                ...
                                                <tr>
                                                    <td>
                                                        <div className="images-outer">
                                                            <img src="\coinhunt\Web - Light\image 4.png" alt="" className="img-fluid" />
                                                            <div className="textss">
                                                                <h4>BitHigh</h4>
                                                                <p>BitHigh</p>
                                                            </div>
                ...
                <section className="Yesterday-mobile d-block d-sm-none">
