...
export const CreateCustomCollection = (name, symbol) => {
    const { account } = useWeb3React();
    const web3 = useWeb3();
    const tokenAddress = environment.BlueMoonCustomCollection;
    const contract = BlueMoonCustomCollectionContract(tokenAddress, web3)
    const createCustomCollection = useCallback(async () => {
    ...
    return { createCustomCollection: createCustomCollection }
}
// export default Mint;